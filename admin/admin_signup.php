...
if (isset($_POST['submit'])) {
    ...
    if ($row > 0) {
        ...
        $msg = mysqli_query($con, "insert into admin(fname,lname,email,password,dept,designation,mobile) values('$fname','$lname','$email','$password','$department','$designation','$contact')");
        if ($msg) {
            $mail = new PHPMailer;
            $toemail = $email;
            // $fname = $row2['fname'];
...
<head>
    ...
    <link rel="icon" href="jss_logo/jsslogoicon.png">
