...
$sql = "SELECT DISTINCT co.subjectcode, co.subject
                                                                            FROM subjectalloted sa
                                                                            JOIN faculty f ON sa.facultyemail = f.email
                                                                            JOIN courseoutcomes co ON sa.suballoted = co.subjectcode
