                                    ...
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    <th>Year</th>
                                                    <td colspan="3"><?php echo $result['year']; ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Semester</th>
                                                ...
                                                <tr>
                                                    <th>Section</th>
                                                    <td colspan="3"><?php echo $result['section']; ?></td>
                                                </tr>
                                                <tr>
                                                    <th>University Roll No.</th>
                                                    <td colspan="3"><?php echo $result['urollno']; ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Admission No.</th>
                                                    <td colspan="3"><?php echo $result['addno']; ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Contact No.</th>
                                ...
                                <div class="p-2 bd-highlight  d-flex justify-content-center">
                                    <div class="d-flex flex-column bd-highlight mb-3">
                                        <div class="p-2 bd-highlight">
                                            ...
                                            {
                                            ?>
                                                <a href="#"><img style="border-radius:50px" src="assets/img/stuimg.webp" width="350" height="350" alt="not found" /></a>
                                            <?php
                                            } else {
                                            ?>
                                                <a href="#"><img style="border-radius:50px" src="uploads/<?php echo $row['img']; ?>" width="350" height="350" alt="not found" /></a>
                                            <?php
                                            }
                                            ?>
                                        </div>
